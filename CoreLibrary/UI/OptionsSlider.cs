...
public class OptionsSlider : Slider
{
    ...
    public OptionsSlider(TextureAtlas atlas)
    {
        ...
        TextureRegion backgroundRegion = atlas.GetRegion("panel_background");
        ...
        _textInstance.CustomFontFile = @"Fonts/WhitePeaberry.fnt";
        ...
        TextureRegion offBackgroundRegion = atlas.GetRegion("slider_off_background");
        ...
        TextureRegion middleBackgroundRegion = atlas.GetRegion("slider_middle_background");
        ...
        TextureRegion maxBackgroundRegion = atlas.GetRegion("slider_max_background");
        ...
        offText.Green = 86;
        offText.Blue = 130;
        offText.CustomFontFile = @"Fonts/WhitePeaberry.fnt";
        ...
        maxText.Green = 86;
        maxText.Blue = 130;
        maxText.CustomFontFile = @"Fonts/WhitePeaberry.fnt";
